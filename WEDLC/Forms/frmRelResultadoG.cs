...
{
    public partial class frmRelResultadoG : Form
    {
        ...
        public frmRelResultadoG(int IdPaciente, Int32 IdFolha, Int32 CodGrupoFolha, string Sigla, string Nome, Int32 idResultado)
        {
            InitializeComponent();
        ...
        private void frmRelResultadoG_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataTable dtResultado = this.buscaRelResultado(); 
                ...
                string path = Path.Combine(Application.StartupPath, "Relatorios", "relResultadoG.rdlc");
                ...
                reportViewer1.LocalReport.DataSources.Add(
                    new ReportDataSource("dsG", dtResultado));

                reportViewer1.LocalReport.DataSources.Add(
                    new ReportDataSource("dsComentarios", dtComentarios));
        ...
        private DataTable buscaRelResultado()
        {
            ...
            {
                DataTable dtAux = new DataTable();
                cAVJ cobjAVJ = new cAVJ();

                cobjAVJ.IdPaciente = pIdPaciente; //Código do resultado
                cobjAVJ.IdFolha = pIdFolha; //Código do resultado

                dtAux = cobjAVJ.BuscaResultadoAVJ();
        ...
        private DataTable buscaRelComentarios(Int32 idResultado)
        {
            try
            {
                ...
                objcComentarioG.IdResultado = idResultado; //Código do resultado

                dtAux = objcComentarioG.BuscaResultadoComentarioG();
