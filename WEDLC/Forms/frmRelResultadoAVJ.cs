...
{
    public partial class frmRelResultadoAVJ : Form
    {
        ...
        public frmRelResultadoAVJ(int IdPaciente, Int32 IdFolha, Int32 CodGrupoFolha, string Sigla, string Nome, Int32 idResultado)
        {
            InitializeComponent();
        ...
        private void frmRelResultadoAVJ_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string path = Path.Combine(Application.StartupPath, "Relatorios", "relResultadoAVJ.rdlc");
                ...
                reportViewer1.LocalReport.DataSources.Add(
                    new ReportDataSource("dsAVJ", dtResultado));
        ...
        private DataTable buscaRelComentarios(Int32 idResultado)
        {
            try
            {
                ...
                objcAVJ.IdResultado = idResultado; //Código do resultado

                dtAux = objcAVJ.BuscaResultadoComentarioAVJ();
