...
namespace WEDLC.Forms
{
    public partial class frmExame : Form
    {
        ...
        private DataTable buscaExame(int tipopesquisa, int idexame, string sigla, string nome)
        {
            try
            {
                ...
                objExame.TipoPesquisa = tipopesquisa;
                objExame.IdExame = idexame;
                objExame.Sigla = sigla;
                objExame.Nome = nome;

                dtAux = objExame.buscaExame();
        ...
        private void populaGrid(int tipopesquisa, int idexame, string sigla, string nome)

        {
            try
            {
                DataTable dt = new DataTable();
                dt = this.buscaExame(tipopesquisa, idexame, sigla, nome);

                grdDados.DataSource = null;

                //Renomeia as colunas do datatable
                dt.Columns["idexame"].ColumnName = "Código";
        ...
        private void btnGravar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objExame.Nome = txtNome.Text;
                objExame.Sigla = txtSigla.Text;
                ...
                if (validaCampos() == true)
                {
                    ...
                    else if (cAcao == Acao.UPDATE)
                    {
                        ...
                        objExame.IdExame= int.Parse(txtCodigo.Text);
                        ...
                        {
                            if (objExame.atualizaExame() == true)
                            {
        ...
        private void btnCancelar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Erro ao tentar cancelar!", "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        }
