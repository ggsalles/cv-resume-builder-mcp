...
{
    public partial class frmRelResultadoPESSMED : Form
    {
        ...
        public frmRelResultadoPESSMED(int IdPaciente, Int32 IdFolha, Int32 CodGrupoFolha, string Sigla, string Nome, Int32 idResultado)
        {
            InitializeComponent();
        ...
        private void frmRelResultadoPESSMED_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataTable dtPESSMED = this.buscaRelResultado(); 
                ...
                string path = Path.Combine(Application.StartupPath, "Relatorios", "relResultadoPESSMED.rdlc");
                ...
                reportViewer1.LocalReport.DataSources.Add(
                    new ReportDataSource("dsPESSMED", dtPESSMED));
        ...
        private DataTable buscaRelResultado()
        {
            ...
            {
                DataTable dtAux = new DataTable();
                cPotenciaisPESSMED objPotenciaisPESSMED = new cPotenciaisPESSMED();

                objPotenciaisPESSMED.IdPaciente = pIdPaciente; //Código do resultado
                objPotenciaisPESSMED.IdFolha = pIdFolha; //Código do resultado

                dtAux = objPotenciaisPESSMED.BuscaResultadoPessMed();
