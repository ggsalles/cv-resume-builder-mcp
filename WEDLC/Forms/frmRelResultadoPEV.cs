...
{
    public partial class frmRelResultadoPEV : Form
    {
        ...
        public frmRelResultadoPEV(int IdPaciente, Int32 IdFolha, Int32 CodGrupoFolha, string Sigla, string Nome, Int32 idResultado)
        {
            InitializeComponent();
        ...
        private void frmRelResultadoPEV_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string path = Path.Combine(Application.StartupPath, "Relatorios", "relResultadoPEV.rdlc");
                ...
                reportViewer1.LocalReport.DataSources.Add(
                    new ReportDataSource("dsResultado", dtResultado));
        ...
        private DataTable buscaRelResultado()
        {
            try
            {
                ...
                objPotenciaisPEV.IdPaciente = pIdPaciente; //Código do resultado
                objPotenciaisPEV.IdFolha = pIdFolha; //Código do resultado

                dtAux = objPotenciaisPEV.BuscaResultadoPev();
