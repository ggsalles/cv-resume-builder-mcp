...
{
    public partial class frmRelResultadoPEGC : Form
    {
        ...
        public frmRelResultadoPEGC(int IdPaciente, Int32 IdFolha, Int32 CodGrupoFolha, string Sigla, string Nome, Int32 idResultado)
        {
            InitializeComponent();
        ...
        private void frmRelResultadoPEGC_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataTable dtPEGC = this.buscaRelResultado(); 
                ...
                string path = Path.Combine(Application.StartupPath, "Relatorios", "relResultadoPEGC.rdlc");
                ...
                reportViewer1.LocalReport.DataSources.Add(
                    new ReportDataSource("dsPEGC", dtPEGC));
        ...
        private DataTable buscaRelResultado()
        {
            ...
            {
                DataTable dtAux = new DataTable();
                cPotenciaisPEGC objPotenciaisPEGC = new cPotenciaisPEGC();

                objPotenciaisPEGC.IdPaciente = pIdPaciente; //Código do resultado
                objPotenciaisPEGC.IdFolha = pIdFolha; //Código do resultado

                dtAux = objPotenciaisPEGC.BuscaResultadoPegc();
